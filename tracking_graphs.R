...
cent_dist_graph <- ggplot() + 
  theme_classic() + 
  geom_line(data=cent_dist, aes(x=step, y=cent), colour="#4E994B", size = 1) +  # line
...
nnd_graph <- ggplot() + 
  theme_classic() + 
  geom_line(data=nnd, aes(x=step, y=nnd), colour="#4E994B", size = 1) +  # line
  theme(axis.text.y = element_text(size = 14, color = "#737373"),  # axis text size & color
        axis.text.x = element_text(size = 14, color = "#737373")) + 
...
area_graph <- ggplot() + 
  theme_classic() + 
  geom_line(data=area, aes(x=step, y=area), colour="#4E994B", size = 1) +  # line
  theme(axis.text.y = element_text(size = 14, color = "#737373"),  # axis text size & color
        axis.text.x = element_text(size = 14, color = "#737373")) + 
...
polar_graph <- ggplot() + 
  theme_classic() + 
  geom_line(data=polar, aes(x=step, y=polar), colour="#4E994B", size = 1) +  # line
  theme(axis.text.y = element_text(size = 14, color = "#737373"),  # axis text size & color
        axis.text.x = element_text(size = 14, color = "#737373")) + 
