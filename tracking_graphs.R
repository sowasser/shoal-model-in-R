...
cent_dist_graph <- ggplot() + 
  ...
  theme(axis.line = element_line(color="#80807F", size = 1),  # axis line & tick color
        axis.ticks = element_line(color="#80807F")) +
...
cent_dist_graph
ggsave(cent_dist_graph, filename = "step1_cent_dist.png", width = 8, height = 5.5, units = "in", 
...
nnd_graph <- ggplot() + 
  ...
  theme(panel.background = element_rect(fill = "transparent"),  # transparent background & no outline
        plot.background = element_rect(fill = "transparent", size = 0))
nnd_graph
ggsave(nnd_graph, filename = "step1_nnd.png", width = 8, height = 5.5, units = "in", 
       dpi = 300, bg = "transparent")
...
area_graph <- ggplot() + 
  ...
  theme(panel.background = element_rect(fill = "transparent"),  # transparent background & no outline
        plot.background = element_rect(fill = "transparent", size = 0))
area_graph
ggsave(area_graph, filename = "step1_area.png", width = 8, height = 5.5, units = "in", 
       dpi = 300, bg = "transparent")
...
polar_graph <- ggplot() + 
  ...
  theme(panel.background = element_rect(fill = "transparent"),  # transparent background & no outline
        plot.background = element_rect(fill = "transparent", size = 0))
polar_graph
ggsave(polar_graph, filename = "step1_polar.png", width = 8, height = 5.5, units = "in", 
       dpi = 300, bg = "transparent")
